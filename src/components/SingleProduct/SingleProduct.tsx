...
function SingleProduct({ productDetails }: { productDetails: Product }) {
  ...
  const findVariationIdAndCreateCartItemObject = async () => {
    ...
    if (selectedVariation) {
      ...
      try {
        ...
        if (!response.ok) {
          console.log("Unable to add to cart: Error Occurred");
        } else {
  ...
  return (
    <div className="container mx-auto grid grid-cols-2 mt-12">
      <div className="image-container col-span-1 p-6">
      ...
      <div className="details-wrapper col-span-1 flex flex-col p-6">
